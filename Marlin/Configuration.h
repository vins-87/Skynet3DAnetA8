...
//  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  ...
  #define LEFT_PROBE_BED_POSITION -20    //25
  #define RIGHT_PROBE_BED_POSITION 198  //195
  #define FRONT_PROBE_BED_POSITION 20   //20
  #define BACK_PROBE_BED_POSITION 176   //170
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT RIGHT_PROBE_BED_POSITION    // X point for Z homing when homing all axis (G28).
